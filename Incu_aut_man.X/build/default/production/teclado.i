...
# 127 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c90\\stdint.h" 3
...
# 263 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c90\\stdint.h" 3
typedef int64_t intmax_t;
# 278 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c90\\stdint.h" 3
typedef uint64_t uintmax_t;
# 289 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c90\\stdint.h" 3
...
unsigned char keyfind(){
    ...
    while(1){
        ...
        if(col_loc==0xe0)
        {
            ...
            if(lim==0) LCD_PutC(keypad[rowloc][0]);
            ...
            if(col_loc==0xd0)
        {
            if(lim==0) LCD_PutC(keypad[rowloc][1]);
            ...
            if(col_loc==0xb0)
        {
            ...
            if(lim==0)LCD_PutC(keypad[rowloc][2]);
            return keypad[rowloc][2];
        }
        else

        {
            if(lim==0) LCD_PutC(keypad[rowloc][3]);
