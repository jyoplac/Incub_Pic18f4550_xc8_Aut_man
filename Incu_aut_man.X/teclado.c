...
unsigned char keyfind(){
    ...
    while(1){
        ...
        {  
            //3 0 on/c
            if(lim==0) LCD_PutC(keypad[rowloc][0]);   /*Display Keypad location on LCD*/
            ...
            if(col_loc==0xd0)
        {
            if(lim==0) LCD_PutC(keypad[rowloc][1]);   /*Display Keypad location on LCD*/
            ...
            if(col_loc==0xb0)
        {
            ...
            if(lim==0)LCD_PutC(keypad[rowloc][2]);   /*Display Keypad location on LCD*/
            return keypad[rowloc][2];       /*Return key pressed value to calling function*/
        }
        else
            
        {
            if(lim==0) LCD_PutC(keypad[rowloc][3]);   /*Display Keypad location on LCD*/
